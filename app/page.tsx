...
export default function TemplateVault() {
  ...
  const [filterType, setFilterType] = useState<"all" | "favorites" | "recent">(
    "all"
  );
  ...
  const [newDomainParentId, setNewDomainParentId] = useState<string | null>(
    null
  );
  ...
  const handleSaveTemplate = async () => {
    ...
    if (mode === "create") {
      await createTemplate({
        ...
        reference_links:
          formData.reference_links.length > 0 ? formData.reference_links : null,
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex h-screen overflow-hidden">
        {/* LEFT SIDEBAR */}
        <aside className="w-56 bg-gray-50 border-r border-gray-200 sticky top-[0px] h-[calc(100vh-64px)] overflow-y-auto">
          <div className="p-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          setNewDomainDescription(e.target.value)
                        }
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(val) =>
                          setNewDomainParentId(val === "__none" ? null : val)
                        }
                      >
                  ...
                  <div key={domain.id}>
                    <div className="flex items-center justify-between">
                      ...
                      >
                        ...
                        {domain.sub_categories &&
                          domain.sub_categories.length > 0 && (
                            <ChevronDown
        ...
        <main
          className={`${
            isTemplateListCollapsed ? "w-48" : "flex-1"
          } p-6 overflow-auto transition-all duration-300 flex flex-col`}
        >
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            navigator.clipboard.writeText( t.content.split("\n").find((p) => p.trim()) ?? "");
                            setIsCopied(true);
        ...
        <aside
          className={`${
            isTemplateListCollapsed ? "flex-1" : "w-96"
          } bg-gray-50 border-l border-gray-200 p-6 flex flex-col transition-all duration-300`}
        >
          {mode === "browse" && selectedTemplate ? (
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex-1 overflow-auto">
                ...
                {selectedTemplate.reference_links &&
                  selectedTemplate.reference_links.length > 0 && (
                    <div>
                      <h4 className="font-semibold text-sm mb-2">
                        Reference Links
                      </h4>
                      <div className="space-y-2">
                        {(selectedTemplate.reference_links as any[]).map(
                          (link, idx) => (
                            <a
                              key={idx}
                              href={link.url}
            ...
            <div className="text-sm text-gray-500">
              Select a template to view or click "Add Template".
            </div>
          )}
        </aside>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  ...
                  onClick={() => {
                    //const shareMessage = `Template: ${shareTemplate.name}\n\n${shareTemplate.content}`;
                     const shareMessage = shareTemplate.content;
                    const whatsappUrl = `https://wa.me/916303765724?text=${encodeURIComponent(
                      shareMessage
                    )}`;
                ...
                <Button
                  ...
                  onClick={() => {
                    // const shareMessage = `Template: ${shareTemplate.name}\n\n${shareTemplate.content}`;
                    const shareMessage = shareTemplate.content;
                    const mailtoUrl = `mailto:najamunnisa00@gmail.com?subject=${encodeURIComponent(
                      shareTemplate.name
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    toast({
                      title: "Content copied! Opening LinkedIn messages...",
                    });
                  }}
                >
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                <p className="text-xs text-gray-600 break-all">
                  {typeof window !== "undefined"
                    ? `${window.location.origin}/share/${shareTemplate.id}`
                    : ""}
                </p>
              </div>
            </div>
