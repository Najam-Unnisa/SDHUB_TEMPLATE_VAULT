...
// --- SVG ICON REPLACEMENTS (Ensures zero dependency errors) ---
const PanelLeftIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-4"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/></svg>
)
      ...
      >
        <SidebarHeader className="border-b pb-4">
          <div className="flex items-center gap-3 px-2">
            <img src={APP_CONFIG.LOGO_URL} alt="Logo" className="size-8 object-contain" />
            <span className="font-bold truncate">{APP_CONFIG.COMPANY_NAME}</span>
          </div>
        </SidebarHeader>
        {children}
      </div>
        ...
        >
          <SheetHeader className="p-4 border-b">
            <div className="flex items-center gap-3">
               <img src={APP_CONFIG.LOGO_URL} alt="Logo" className="size-8 object-contain" />
               <SheetTitle className="text-left font-bold">{APP_CONFIG.COMPANY_NAME}</SheetTitle>
            </div>
        ...
        >
          <SidebarHeader className="group-data-[collapsible=icon]:items-center">
            <div className="flex items-center gap-3 px-1 h-10 overflow-hidden">
               <img src={APP_CONFIG.LOGO_URL} alt="Logo" className="size-8 shrink-0 object-contain" />
